  ...
  return (
    <div className="w-full py-6">
      <div className="max-w-4xl mx-auto px-4">
        {/* Desktop Filter Bar */}
        <div className="hidden md:flex items-center justify-center gap-1 bg-white shadow-lg px-6 py-3 rounded-full border border-gray-200">
          {/* Search by Name */}
        ...
        <div className="md:hidden space-y-4">
          <div className="bg-white shadow-lg rounded-2xl border border-gray-200 p-4">
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 bg-gray-50 text-gray-700 text-sm border border-gray-200 rounded-full focus:border-blue-400 focus:outline-none"
                value={filters.searchName}
                onChange={(e) => handleFilterChange('searchName', e.target.value)}
              />
              <button 
                onClick={handleSearch}
                className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-full transition-colors duration-200"
              >
                <FiSearch size={16} />
              </button>
            </div>
          ...
          <div className="bg-white shadow-lg rounded-2xl border border-gray-200 p-4">
            <div className="grid grid-cols-2 gap-3">
              <div className="relative">
                <select 
                  className="w-full appearance-none px-3 py-3 pr-8 bg-gray-50 text-gray-700 text-sm border border-gray-200 rounded-lg focus:border-blue-400 focus:outline-none cursor-pointer"
                  value={filters.category}
                  onChange={(e) => handleFilterChange('category', e.target.value)}
                >
                  <option value="Diesel mechanics">Diesel mechanics</option>
