...
const SearchedMechanics = ({ isAuthenticated }) => {
                  ...
                  <div className="p-4 sm:p-5 md:p-6">
                    ...
                    <div className="flex gap-2 sm:gap-3">
                      <button 
                        ...
                        className={`flex-1 font-medium sm:font-semibold py-2 sm:py-2.5 md:py-3 px-3 sm:px-4 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 shadow-lg ${
                          isAuthenticated 
                            ? 'bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white hover:shadow-xl cursor-pointer'
                            : 'bg-gray-400 text-gray-200 cursor-not-allowed'
                        }`}
                        title={!isAuthenticated ? 'Please log in to book' : ''}
                      >
